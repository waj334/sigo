...
namespace mlir::go {
    namespace transforms::core {
        struct AddCOpLowering : public OpConversionPattern<AddCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(AddCOp op, OpAdaptor adaptor,
        ...
        struct AddFOpLowering : public OpConversionPattern<AddFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(AddFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct AddIOpLowering : public OpConversionPattern<AddIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(AddIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct AndNotOpLowering : public OpConversionPattern<AndNotOp> {
            ...
            mlir::LogicalResult matchAndRewrite(AndNotOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct BrOpLowering : public OpConversionPattern<BranchOp> {
            ...
            mlir::LogicalResult matchAndRewrite(BranchOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct CallIndirectOpLowering : public OpConversionPattern<CallIndirectOp> {
            ...
            mlir::LogicalResult matchAndRewrite(CallIndirectOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                ...
                auto callOp = rewriter.create<func::CallIndirectOp>(op.getLoc(), adaptor.getCallee(),
        ...
        struct ComplexOpLowering : public OpConversionPattern<ComplexOp> {
            ...
            mlir::LogicalResult matchAndRewrite(ComplexOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                auto resultType = typeConverter->convertType(op.getType());
                rewriter.replaceOpWithNewOp<mlir::complex::CreateOp>(op, resultType, adaptor.getReal(),
                                                                     adaptor.getImag());
                return success();
            }
        };
        ...
        struct CmpCOpLowering : public OpConversionPattern<CmpCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(CmpCOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                mlir::Location loc = op.getLoc();
                rewriter.setInsertionPointAfter(op->getPrevNode());
                ...
                // SPEC: Complex types are comparable. Two complex values u and v are equal if both real(u) == real(v) and
                //       imag(u) == imag(v).
                auto cmpRealOp = rewriter.create<mlir::arith::CmpFOp>(loc, pred, realLhsOp.getResult(),
                                                                      realRhsOp.getResult());
                auto cmpImagOp = rewriter.create<mlir::arith::CmpFOp>(loc, pred, imagLhsOp.getResult(),
                                                                      imagRhsOp.getResult());
                auto andOp = rewriter.create<mlir::arith::AndIOp>(loc, cmpRealOp.getResult(), cmpImagOp.getResult());
        ...
        struct CmpFOpLowering : public OpConversionPattern<CmpFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(CmpFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct CmpIOpLowering : public OpConversionPattern<CmpIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(CmpIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct CondBrOpLowering : public OpConversionPattern<CondBranchOp> {
            ...
            mlir::LogicalResult matchAndRewrite(CondBranchOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                rewriter.replaceOpWithNewOp<cf::CondBranchOp>(op, adaptor.getCondition(), op.getTrueDest(),
        ...
        struct DivCOpLowering : public OpConversionPattern<DivCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(DivCOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct DeclareTypeOpLowering : public OpConversionPattern<DeclareTypeOp> {
            ...
            mlir::LogicalResult matchAndRewrite(DeclareTypeOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                // Drop this operation.
                rewriter.eraseOp(op);
                return success();
        ...
        struct DivFOpLowering : public OpConversionPattern<DivFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(DivFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct DivSIOpLowering : public OpConversionPattern<DivSIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(DivSIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct DivUIOpLowering : public OpConversionPattern<DivUIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(DivUIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct GlobalOpLowering : public OpConversionPattern<GlobalOp> {
            ...
            mlir::LogicalResult matchAndRewrite(GlobalOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                // Create a replacement global operation with no initializer body.
                auto newGlobalOp = rewriter.create<GlobalOp>(op.getLoc(), adaptor.getGlobalTypeAttr(),
        ...
        struct ImagOpLowering : public OpConversionPattern<ImagOp> {
            ...
            mlir::LogicalResult matchAndRewrite(ImagOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                auto resultType = typeConverter->convertType(op.getType());
        ...
        struct MulCOpLowering : public OpConversionPattern<MulCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(MulCOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct MulFOpLowering : public OpConversionPattern<MulFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(MulFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct MulIOpLowering : public OpConversionPattern<MulIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(MulIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct RealOpLowering : public OpConversionPattern<RealOp> {
            ...
            mlir::LogicalResult matchAndRewrite(RealOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                auto resultType = typeConverter->convertType(op.getType());
        ...
        struct RemFOpLowering : public OpConversionPattern<RemFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(RemFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct RemSIOpLowering : public OpConversionPattern<RemSIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(RemSIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct RemUIOpLowering : public OpConversionPattern<RemUIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(RemUIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct ShlOpLowering : OpConversionPattern<ShlOp> {
            ...
            LogicalResult
            matchAndRewrite(ShlOp op, OpAdaptor adaptor, ConversionPatternRewriter &rewriter) const override {
        ...
        struct ShrSIOpLowering : OpConversionPattern<ShrSIOp> {
            ...
            LogicalResult matchAndRewrite(ShrSIOp op, OpAdaptor adaptor,
                                          ConversionPatternRewriter &rewriter) const override {
                const Type resultType = typeConverter->convertType(op.getType());
        ...
        struct ShrUIOpLowering : OpConversionPattern<ShrUIOp> {
            ...
            LogicalResult matchAndRewrite(ShrUIOp op, OpAdaptor adaptor,
                                          ConversionPatternRewriter &rewriter) const override {
                const Type resultType = typeConverter->convertType(op.getType());
                rewriter.replaceOpWithNewOp<mlir::arith::ShRUIOp>(op, resultType, adaptor.getLhs(), adaptor.getRhs());
                return success();
            }
        };
        ...
        struct SubCOpLowering : public OpConversionPattern<SubCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(SubCOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct SubFOpLowering : public OpConversionPattern<SubFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(SubFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct SubIOpLowering : public OpConversionPattern<SubIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(SubIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct ConstantOpLowering : public OpConversionPattern<ConstantOp> {
            ...
            mlir::LogicalResult matchAndRewrite(ConstantOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct FloatTruncateOpLowering : public OpConversionPattern<FloatTruncateOp> {
            ...
            mlir::LogicalResult matchAndRewrite(FloatTruncateOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct FloatExtendOpLowering : public OpConversionPattern<FloatExtendOp> {
            ...
            mlir::LogicalResult matchAndRewrite(FloatExtendOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct IntTruncateOpLowering : public OpConversionPattern<IntTruncateOp> {
            ...
            mlir::LogicalResult matchAndRewrite(IntTruncateOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct SignedExtendOpLowering : public OpConversionPattern<SignedExtendOp> {
            ...
            mlir::LogicalResult matchAndRewrite(SignedExtendOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct ZeroExtendOpLowering : public OpConversionPattern<ZeroExtendOp> {
            ...
            mlir::LogicalResult matchAndRewrite(ZeroExtendOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct FloatToUnsignedIntOpLowering : public OpConversionPattern<FloatToUnsignedIntOp> {
            ...
            mlir::LogicalResult matchAndRewrite(FloatToUnsignedIntOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct FloatToSignedIntOpLowering : public OpConversionPattern<FloatToSignedIntOp> {
            ...
            mlir::LogicalResult matchAndRewrite(FloatToSignedIntOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct UnsignedIntToFloatOpLowering : public OpConversionPattern<UnsignedIntToFloatOp> {
            ...
            mlir::LogicalResult matchAndRewrite(UnsignedIntToFloatOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct SignedIntToFloatOpLowering : public OpConversionPattern<SignedIntToFloatOp> {
            ...
            mlir::LogicalResult matchAndRewrite(SignedIntToFloatOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct NegCOpLowering : public OpConversionPattern<NegCOp> {
            ...
            mlir::LogicalResult matchAndRewrite(NegCOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct NegFOpLowering : public OpConversionPattern<NegFOp> {
            ...
            mlir::LogicalResult matchAndRewrite(NegFOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
        ...
        struct NegIOpLowering : public OpConversionPattern<NegIOp> {
            ...
            mlir::LogicalResult matchAndRewrite(NegIOp op, OpAdaptor adaptor,
                                                ConversionPatternRewriter &rewriter) const override {
                auto constOp = rewriter.create<mlir::arith::ConstantOp>(
    ...
    void populateGoToCoreConversionPatterns(mlir::MLIRContext *context, TypeConverter &converter,
