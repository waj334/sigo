...
func unwrapPassManager(pm mlir.PassManager) C.MlirPassManager {
	return C.MlirPassManager{ptr: pm.Ptr()}
}

func unwrapOpPassManager(pm mlir.OpPassManager) C.MlirOpPassManager {
	return C.MlirOpPassManager{ptr: pm.Ptr()}
}
